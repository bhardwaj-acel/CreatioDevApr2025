		...
		handlers: /**SCHEMA_HANDLERS*/[
			...
			},
			{
				...
				handler: async (request, next) => {
					...
					var typeObject = await request.$context.PDS_UsrType_kqbglms;
					var typeId = "";
					if (typeObject) {
						typeId = typeObject.value;
					}
					// get id from type lookup offer type object
					var offerTypeObject = await request.$context.PDS_UsrOfferType_3wfvqit;
					var offerTypeId = "";
					if (offerTypeObject) {
...
/* Create an instance of the HTTP client from @creatio-devkit/common. */
					...
					//const endpoint = "http://localhost/D2_Studio/0/rest/RealtyService/GetMaxPriceByTypeId";
